...
<nav>
    ...
    <div class="dropdown-menu" aria-labelledby="dropdown09">
        ...
        <a class="dropdown-item" href="${pageContext.servletContext.contextPath}/controller?command=locale&currentPage=${param.currentPage}&lang=de_DE"><img src="img/flag/de.png" width="40" height="20" alt="De"> De</a>
    </div>
</nav>
